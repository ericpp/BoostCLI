...
class Lightning(object):
    ...
    def SendOnionMessage(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/lnrpc.Lightning/SendOnionMessage',
    ...
    def SubscribeOnionMessages(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_stream(request, target, '/lnrpc.Lightning/SubscribeOnionMessages',
